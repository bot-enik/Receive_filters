...
% Оценка влияния 'плавающих' фильтров
% Производится перед расчетом фильтров с фиксированной точкой
...
% Находить коэффициент усиления каскадов фильтра для масштабирования
% не нужно, так как фильтры с единичным усилением
